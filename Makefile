...
SOURCES		= stm32-lpc.c usbcdc.c extuart.c delay.c flash.c debug.c usbopt.c usbdma.c mutex.c
DEPS		= extuart.h flash.h main.h uart.h usbcdc.h debug.h usbopt.h usbdma.h mutex.h
