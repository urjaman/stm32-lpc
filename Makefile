...
SOURCES		= stm32-lpc.c usbcdc.c extuart.c delay.c flash.c debug.c mutex.c dmacopy.c
DEPS		= extuart.h flash.h main.h uart.h usbcdc.h debug.h mutex.h dmacopy.h
